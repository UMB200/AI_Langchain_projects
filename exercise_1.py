...
def implement_llama_4_model():
    ...
    return ChatGroq(model = "llama-4-8b-instant", temperature=0.0)
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama_model_4 = implement_llama_4_model()
    llama_model_3 = implement_llama_3_3_model()
    
    llama_model_4_response = implement_query_model(llama_model_4, prompt)
    llama_model_3_response = implement_query_model(llama_model_3, prompt)
    
    return { 
        "llama_4": llama_model_4_response,
        "llama_3": llama_model_3_response
        }
